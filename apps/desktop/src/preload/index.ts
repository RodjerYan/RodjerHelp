...
const accomplishAPI = {
  ...
  // Chat attachments
  pickChatFiles: (): Promise<Array<{ path: string; name: string; size: number; lastModified: number }>> =>
    ipcRenderer.invoke('chat:pick-files'),
...
// Type declarations
export type RodjerHelpAPI = typeof accomplishAPI;
