...
let capturedRodjerHelpAPI: Record<string, unknown> = {};
let capturedRodjerHelpShell: Record<string, unknown> = {};

describe('Preload Script Integration', () => {
  beforeEach(async () => {
    vi.clearAllMocks();
    capturedRodjerHelpAPI = {};
    capturedRodjerHelpShell = {};
    ...
    mockExposeInMainWorld.mockImplementation((name: string, api: unknown) => {
      if (name === 'accomplish') {
        capturedRodjerHelpAPI = api as Record<string, unknown>;
      } else if (name === 'accomplishShell') {
        capturedRodjerHelpShell = api as Record<string, unknown>;
      }
    });
  ...
  describe('API Exposure', () => {
    it('should expose accomplish API via contextBridge', () => {
      ...
      expect(capturedRodjerHelpAPI).toBeDefined();
    });
    ...
    it('should expose accomplishShell info via contextBridge', () => {
      ...
      expect(capturedRodjerHelpShell).toBeDefined();
    });

    it('should expose shell info with isElectron=true', () => {
      expect(capturedRodjerHelpShell.isElectron).toBe(true);
    });

    it('should expose shell info with platform', () => {
      expect(capturedRodjerHelpShell.platform).toBe(process.platform);
    });

    it('should expose shell info with version matching package.json', () => {
      expect(capturedRodjerHelpShell.version).toBe(pkg.version);
    });
  });
  ...
  describe('IPC Method Invocations', () => {
    describe('App Info', () => {
      it('getVersion should invoke app:version', async () => {
        await (capturedRodjerHelpAPI.getVersion as () => Promise<string>)();
        expect(mockInvoke).toHaveBeenCalledWith('app:version');
      });

      it('getPlatform should invoke app:platform', async () => {
        await (capturedRodjerHelpAPI.getPlatform as () => Promise<string>)();
    ...
    describe('Shell Operations', () => {
      it('openExternal should invoke shell:open-external with URL', async () => {
        ...
        await (capturedRodjerHelpAPI.openExternal as (url: string) => Promise<void>)(url);
    ...
    describe('Task Operations', () => {
      it('startTask should invoke task:start with config', async () => {
        ...
        await (
          capturedRodjerHelpAPI.startTask as (config: { description: string }) => Promise<unknown>
        )(config);
        expect(mockInvoke).toHaveBeenCalledWith('task:start', config);
      });

      it('cancelTask should invoke task:cancel with taskId', async () => {
        await (capturedRodjerHelpAPI.cancelTask as (taskId: string) => Promise<void>)('task_123');
      ...
      it('interruptTask should invoke task:interrupt with taskId', async () => {
        await (capturedRodjerHelpAPI.interruptTask as (taskId: string) => Promise<void>)(
          'task_123',
        );
    ...
    describe('Permission Operations', () => {
      it('respondToPermission should invoke permission:respond', async () => {
        ...
        await (
          capturedRodjerHelpAPI.respondToPermission as (r: {
            taskId: string;
            allowed: boolean;
          }) => Promise<void>
        )(response);
    ...
    describe('Session Operations', () => {
      it('resumeSession should invoke session:resume', async () => {
        await (
          capturedRodjerHelpAPI.resumeSession as (
            s: string,
            p: string,
            t?: string,
          ) => Promise<unknown>
    ...
    describe('Settings Operations', () => {
      it('getDebugMode should invoke settings:debug-mode', async () => {
        await (capturedRodjerHelpAPI.getDebugMode as () => Promise<boolean>)();
        expect(mockInvoke).toHaveBeenCalledWith('settings:debug-mode');
      });

      it('setDebugMode should invoke settings:set-debug-mode', async () => {
        await (capturedRodjerHelpAPI.setDebugMode as (enabled: boolean) => Promise<void>)(true);
    ...
    describe('Onboarding Operations', () => {
      it('getOnboardingComplete should invoke onboarding:complete', async () => {
        await (capturedRodjerHelpAPI.getOnboardingComplete as () => Promise<boolean>)();
      ...
      it('setOnboardingComplete should invoke onboarding:set-complete', async () => {
        await (capturedRodjerHelpAPI.setOnboardingComplete as (c: boolean) => Promise<void>)(true);
    ...
    describe('Model Operations', () => {
      it('getSelectedModel should invoke model:get', async () => {
        await (capturedRodjerHelpAPI.getSelectedModel as () => Promise<unknown>)();
      ...
      it('setSelectedModel should invoke model:set', async () => {
        ...
        await (
          capturedRodjerHelpAPI.setSelectedModel as (m: {
            provider: string;
            model: string;
          }) => Promise<void>
        )(model);
    ...
    describe('Logging Operations', () => {
      it('logEvent should invoke log:event', async () => {
        ...
        await (capturedRodjerHelpAPI.logEvent as (p: unknown) => Promise<unknown>)(payload);
    ...
    describe('Skills Operations', () => {
      it('getUserSkillsPath should invoke skills:get-user-skills-path', async () => {
        await (capturedRodjerHelpAPI.getUserSkillsPath as () => Promise<string>)();
  ...
  describe('Event Subscriptions', () => {
    it('onTaskUpdate should subscribe to task:update', () => {
      ...
      (capturedRodjerHelpAPI.onTaskUpdate as (cb: (e: unknown) => void) => () => void)(callback);
    ...
    it('onTaskUpdate should return unsubscribe function', () => {
      const callback = vi.fn();
      const unsubscribe = (
        capturedRodjerHelpAPI.onTaskUpdate as (cb: (e: unknown) => void) => () => void
      )(callback);
      unsubscribe();
    ...
    it('onTaskUpdateBatch should subscribe to task:update:batch', () => {
      const callback = vi.fn();
      (capturedRodjerHelpAPI.onTaskUpdateBatch as (cb: (e: unknown) => void) => () => void)(
        callback,
      );
    ...
    it('onPermissionRequest should subscribe to permission:request', () => {
      const callback = vi.fn();
      (capturedRodjerHelpAPI.onPermissionRequest as (cb: (e: unknown) => void) => () => void)(
        callback,
      );
    ...
    it('onTaskProgress should subscribe to task:progress', () => {
      const callback = vi.fn();
      (capturedRodjerHelpAPI.onTaskProgress as (cb: (e: unknown) => void) => () => void)(callback);
      expect(mockOn).toHaveBeenCalledWith('task:progress', expect.any(Function));
    });

    it('onDebugLog should subscribe to debug:log', () => {
      const callback = vi.fn();
      (capturedRodjerHelpAPI.onDebugLog as (cb: (e: unknown) => void) => () => void)(callback);
    ...
    it('onTaskStatusChange should subscribe to task:status-change', () => {
      const callback = vi.fn();
      (capturedRodjerHelpAPI.onTaskStatusChange as (cb: (e: unknown) => void) => () => void)(
        callback,
      );
